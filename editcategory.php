					...
					<div class="card-body">
						<?php
							...
							if (isset($_POST['submit'])) {
								...
								if($_FILES['photo']['name']!=""){
									...
									$query = "UPDATE tbl_category SET cat_name = '".$name."', photo_cat = '".$md5photo."', cat_status = '".$valueStatus."', cat_background = '".$bg."' WHERE cat_id = '".$id."'";
								...
								$query = "UPDATE tbl_category SET cat_name = '".$name."', cat_status = '".$valueStatus."', cat_background = '".$bg."' WHERE cat_id = '".$id."'";
								mysqli_query($conn, $query);
						...
						<form class="form" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input class="form-control" name="name" value="<?php echo $result['cat_name']; ?>">
								</div>
							</div>												
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<div class="fileupload fileupload-new" data-provides="fileupload">
										<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
											<img src="<?php include 'image/baseurl.php'; echo $file_path.'image/'.$result['photo_cat'];?>" alt=""/>
										</div>
							...
							<div class="form-group row">
								<label class="col-lg-3 col-form-label form-control-label">Color Background</label>
								<div class="col-lg-9">
									<input type="color" id="color" name="bg" value="<?php echo $result['cat_background']; ?>">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<div class="checkbox anim-checkbox">
										<input type="checkbox" id="ch3" name="status[]" value="1" <?php if($result['cat_status']=="1"){ ?>checked<?php }?>/>
