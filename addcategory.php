				...
				<div class="card">
					...
					<div class="card-body">
						<form class="form" role="form" method="post" action="action/add_category.php" enctype="multipart/form-data" autocomplete="off">
							...
							<div class="form-group row">
								<label class="col-lg-3 col-form-label form-control-label">Category Image</label>
								<div class="col-lg-9">
									<div class="fileupload fileupload-new" data-provides="fileupload">
										...
										<div>
											<span class="btn btn-file btn-primary">
												...
												<input type="file" name="photo" accept="image/x-png" required></span>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<input type="color" id="color" name="bg" value="#2933c7">
								</div>
							</div>
							<div class="form-group row">
